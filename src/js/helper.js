...
export const generateMarkupC = function(){
    ...
    <div class="title-container">
        <h2 class="low-font">Lets get your curiosity going!</h2>
    </div>
    </div>
    <section>
    <div class="test-quote-div grid-set">
        ...
        <div class="grid-set-inner">
            <div class="jkshkil">
                <p class="quote-holder-c1 quote-set low-font">"Curiosity is the engine of achievement." - Ken Robinson</p>
            </div>
    ...
    <div class="test-quote-div grid-set">
        ...
        <div class="grid-set-inner">
            <div class="jkshkil">
                <p class="quote-holder-c2 quote-set low-font">"I am the number one most impactful artist of our generation, in the flesh. I am Shakespeare, Walt Disney." - Kanye West</p>
            </div>
            <div class="low-font quote">
...
export const generateMarkupI = function(){
    ...
    <div class="test-quote-div grid-set">
        ...
        <div class="grid-set-inner">
            <div class="jkshkil">
                <p class="quote-holder-I1 quote-set low-font">"I'm not in this world to live up to your expectations and you're not in this world to live up to mine" - Bruce Lee</p>
            </div>
            <div class="low-font quote">
        ...
        <div>
            <button class="clickedI1 btn">Uplifting Quote</button>
        </div>
    </div>
    </section>
    <hr>
...
export const generateMarkupD = function(){
    ...
    <div class="sect-wrapper">
    <div class="title-container">
        <h2 class="low-font">Lets get some positive quotes going!</h2>
    </div>
    </div>
    <section>
    <div class="test-quote-div grid-set">
        ...
        <div class="grid-set-inner">
            <div class="jkshkil">
                <p class="quote-holder-d1 quote-set low-font">"Just because today is a bad day doesn't mean tomorrow won't be the best day of your life. You just gotta get there."</p>
            </div>
            <div class="low-font quote">
    ...
    <div class="test-quote-div grid-set">
        ...
        <div class="grid-set-inner">
            <div class="jkshkil">
                <p class="quote-holder-d2 quote-set low-font">"Whenever you're going through a bad day just remember, your track record for getting through bad days, so far, is 100%. That's pretty darn good."</p>
            </div>
            <div class="low-font quote">
...
export const generateMarkupH = function(){
    ...
    <div class="test-quote-div grid-set">
        ...
        <div class="grid-set-inner">
            <div class="jkshkil">
                <p class="quote-holder-h1 quote-set low-font">"I'm not in this world to live up to your expectations and you're not in this world to live up to mine" - Bruce Lee</p>
            </div>
            <div class="low-font">
    ...
    <div class="test-quote-div grid-set">
        ...
        <div class="grid-set-inner">
            <div class="jkshkil">
                <p class="quote-holder-h2 quote-set low-font">"A calm and modest life brings more happiness than the pursuit of success combined with constant restlessness." - Albert Einstein</p>
            </div>
            <div class="low-font">
